...
namespace Finance_Tracker.Migrations
{
    ...
    partial class FinanceTrackerDBModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finance_Tracker.Models.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Finance_Tracker.Models.CostInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Finance_Tracker.Models.Company", b =>
                {
                    b.HasOne("Finance_Tracker.Models.CostInvoice", "CostInvoice")
                        .WithMany()
            ...
            modelBuilder.Entity("Finance_Tracker.Models.Invoice", b =>
                {
                    b.HasOne("Finance_Tracker.Models.Company", "Company")
                        .WithMany("Invoices")
